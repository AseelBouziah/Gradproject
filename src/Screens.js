...
//import ImagePickerE from "./components/ImagePickerE";
import {Input} from './components/Input';
import {FilledButton} from './components/FilledButton';
import {TextButton} from './components/TextButton';
import {Error} from './components/Error';
import Map from "./components/Map";
import {TextInput,Card,Title,IconButton} from 'react-native-paper'
...
export const Recipe = ({route , navigation}) => {
  ...
  const [integrades,setIntegrades] = useState()
  const [way,setWay] = useState()
  const [value, onChangeText] = React.useState('-1\n-2\n-3\n-4\n-5\n');
 
  const submitData = ()=>{
   fetch("http://192.168.1.8:3000/recipe",{
            method:"post",
            headers:{
              'Content-Type': 'application/json'
            },
  ...
  return (
    ...
    fontWeight: 'bold'}} >ابحث عن أقرب سوبر ماركت لتوفير مكوناتك</Text>
          <Map/>
           ...
           <View style={{
               ...
               borderBottomWidth: 1,
                         ...
                         <Text style={styles.categoryItemTitle}>أضف وصفتك</Text>

                <View>
                 <Text style={{color:'#000000', fontWeight:'bold',textAlign:'right'}}>اسم الوصفة:</Text>
               </View>
               <UselessTextInput
               ...
               />
                     ...
                     <View>
                 <Text style={{color:'#000000', fontWeight:'bold',textAlign:'right'}}>المكونات:</Text>
               </View>
                <UselessTextInput
                multiline
                numberOfLines={4}
                placeholder={"_1\n\n_2\n\n_3"}
                style={styles.input}
                 onChangeText={text => setIntegrades(text)}        />
                       <View style={{borderBottomColor: 'black',borderBottomWidth: 1,}}/>
                       <View>
                 <Text style={{color:'#000000', fontWeight:'bold',textAlign:'right'}}>الطريقة:</Text>
               </View>
               <UselessTextInput
                 multiline
                 numberOfLines={4}
    ...
    return (
      ...
      <View style={{flex:1, marginTop:50}}>
        ...
        <SettingsList.Item
            ...
            />
            <SettingsList.Item
            title='وصفاتك التي قمت بإضافتها'
            backgroundColor='#D1D1D1'
            titleStyle={{color:'blue'}}
            arrowStyle={{tintColor:'blue'}} 
             onPress={() =>
              navigation.navigate('Wasfatk')
            }
            />
        <SettingsList.Item
            title='قائمة المفضلة'
...
<TextButton
  ...
  const [conPassword,setConfirm] = useState()
   ...
   const submitData = ()=>{
    fetch("http://192.168.1.8:3000/customers",{
             method:"post",
             headers:{
               'Content-Type': 'application/json'
             },
